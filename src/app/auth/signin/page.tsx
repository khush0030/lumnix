    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0F172A', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#F8FAFC', fontFamily: 'var(--font-display)' }}>Welcome back</h1>
          <p style={{ fontSize: '14px', color: '#64748B', marginTop: '4px', fontFamily: 'var(--font-body)' }}>Sign in to your Lumnix account</p>
        </div>
